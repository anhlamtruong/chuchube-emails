      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mb-4 rounded-lg bg-blue-50 border border-blue-200 px-4 py-3 text-xs text-blue-800">
            ...
            Outlook SMTP ~300/day &middot; Resend Free 100/day (3K/month) &middot;
            Resend Pro $20/mo for 50K/mo
          </div>
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        <Badge
                          variant={a.provider === "resend" ? "secondary" : "default"}
        ...
        >
          ...
          <DialogFooter>
            <Button
              ...
              disabled={
                accountTesting ||
                (!accountForm.credential && !editingAccount)
              }
            >
              {accountTesting ? (
